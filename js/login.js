  ...
  if (email.value === "" || password.value === "") {
    if (email.value === "") {
      ...
      email.insertAdjacentHTML(
        "afterend",
        '<p id="email-error" style="color:red">Please enter your email</p>'
      );
    }
    if (password.value === "") {
      ...
      password.insertAdjacentHTML(
        "afterend",
        '<p id="password-error" style="color:red">Please enter your password</p>'
      );
    }
  } else {
    ...
    if (user && user.password === password.value) {
      ...
      password.insertAdjacentHTML(
        "afterend",
        '<p id="password-error" style="color:red">User does not exist</p>'
      );
    }
  }
});
